...

{
     ...
     window.addEventListener("scroll", function () {
          ...
          const menuItem = document.querySelectorAll('.header-menu__link');
...

{
     ...
     document.addEventListener("scroll", function () {
          targetElements.forEach(function (targetElement) {
               const getElementDistance = targetElement.getBoundingClientRect().top + targetElement.clientHeight * 0.4;
